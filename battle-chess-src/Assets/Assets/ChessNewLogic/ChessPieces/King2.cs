	...
	public override SpecialMove GetSpecialMoves(ref ChessPiece[,] board, ref List<Vector2Int[]> moveList, ref List<Vector2Int> availableMoves)
	{
		...
		if (kingMove == null && currentX == 4)
		{
			...
			if (team == 0)
			{
				//Left Rook
				if (leftRook == null)
					if(board[0, 0].type == ChessPieceType.Rook2)
						if(board[0, 0].team == 0)
							if(board[3, 0] == null)
								if(board[2, 0] == null)
									if(board[1, 0] == null)
								...
								//Right Rook
				if (RightRook == null)
					if(board[7, 0].type == ChessPieceType.Rook2)
						if(board[7, 0].team == 0)
							if(board[5, 0] == null)
								if(board[6, 0] == null)
								{
			...
			else
			{
				...
				// Left Rook
				if (leftRook == null)
					if(board[0, 7].type == ChessPieceType.Rook2)
						if(board[0, 7].team == 1)
							if(board[3, 7] == null)
								if(board[2, 7] == null)
									if(board[1, 7] == null)
								...
								//Right Rook
				if (RightRook == null)
					if(board[7, 7].type == ChessPieceType.Rook2)
						if(board[7, 7].team == 1)
							if(board[5, 7] == null)
								if(board[6, 7] == null)
								{
